...
const {mains,sides,drinks} = data_coffee;

const CafeDelicias = () => {
  const direccion = RestaurantAddressBook["/cafe_delicias"];
  ...
  return (
        <div className="menu">
          ...
          <div className="circle logo-centered">
            <img src={Logo} alt={"Café Delicias"}/>
          </div>
          <div>
